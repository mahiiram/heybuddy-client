...
function Login() {
  ...
  return (
    ...
    <input className="emailInput" type='text' name='email' placeholder='Phone number,email address'  value={email} onChange={(e)=>setEmail(e.target.value)}/>
    <input className="PasswordInput"   type='password' name='email' placeholder='Password' value={password} onChange={(e)=>setpassword(e.target.value)} />
